...
getAdd1 = do
    Control.Monad.Cont.runCont (add_cont 1 2) print
...
getPyth = do
    Control.Monad.Cont.runCont (pyth_cont 2 3) print
...
getPyth3 x = do      
    a <- (square_cont 2) -- don't need return as already a Cont (I think)
    b <- return 10
    return $ a+b
...
testPyth3 = Control.Monad.Cont.runCont (getPyth3 2) show    
